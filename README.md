...
<details>
  ...
  O simbolo 🔽 é uma caixa de seleção, como um `<select>` HTML, este abriga os modos de depuração que o VScode encontrou.
   ...
   2. Depurar com Docker
    - Como o último, mas o VScode usa a porta `9229` para atracar com o código da API no _container_, se quiser fazer requisitões para API deve usar a porta que o _container_ mapeou para o `localhost`
  ...
  Inicialmente vai parecer que nada aconteceu, mas vai aparecer essa barinha no topo da sua tela:
  ...
  Com tudo preparado, vamos fazer um teste, vou fazer uma requisição para acionar a excução da linha 7 do `src/app.js`:
...
- `git clone git@github.com:tryber/sd-021-a-store-manager.git`;

- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-021-a-store-manager`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
  ...
  - Exemplo: `git checkout -b joaozinho-sd-021-a-store-manager-rubric`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-021-a-store-manager-rubric`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-021-a-store-manager-rubric/pulls)
